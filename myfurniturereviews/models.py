...
class Furnitures(models.Model):
    ...
    furnitureshop = models.ForeignKey(FurnitureShop, null=True, related_name='furni',on_delete=models.PROTECT)
...
class FurnitureReview(Review):
    furnitureshop = models.ForeignKey(FurnitureShop,on_delete=models.PROTECT)
